...
import { playersData, type TeamId } from '@/lib/playersData';
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          <h1 style={{ fontSize: '3rem', fontFamily: 'Playfair Display, serif', fontWeight: 800 }} className="mb-4">プロ野球選手名鑑</h1>
          <p className="text-lg font-light">2026年度版</p>
        </div>
      </section>
